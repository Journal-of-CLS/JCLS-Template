...
\resources{
	data={Data can be found here: \url{data.example.edu/data}},
	software={Software can be found here: \url{git.example.com/something}},
%	data+software={Combined repository for data + software can be found at: \url{git.example.com/combined-data+software-repo}},
}
